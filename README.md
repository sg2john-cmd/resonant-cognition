...
## 🛠️ Running the Interactive Prototype
To visually interact with the 7-planet gravitational intent engine:
1. Clone or download `resonant_simulation.html` onto your system.
2. Open the file in any standard modern web browser.
3. Interact with the live tracking modules to watch wave gradients adjust, or execute the **Black Hole Purge** command to trigger a topological system defragmentation.

## 🛡️ License & Protections
This project is officially licensed under **Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)**. Independent developers, researchers, and hobbyists are fully encouraged to fork, adapt, and build upon this framework for non-commercial exploration with attribution. Commercial exploitation of these structural architectures is strictly prohibited without explicit layout licensing.
